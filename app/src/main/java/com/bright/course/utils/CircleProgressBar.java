...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
        ...
        mBackgroundPaint.setColor(0xffCCCCCC);//默认背景颜色
        setBackgroundResource(0);//移除设置的背景资源

        mProgressPaint = new Paint();//进度条画笔
        mProgressPaint.setAntiAlias(true);
        mProgressPaint.setColor(0xff29C1AC);//默认背景颜色
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(bgRectF, mViewHeight / 6.5f, mViewHeight / 6.5f, mBackgroundPaint);
        //画进度条
        ...
        if (width <= mViewHeight) {//圆形
            ...
            canvas.drawRoundRect(progressRectF, mViewHeight / 6.5f, mViewHeight / 6.5f, mProgressPaint);
        }
    }
