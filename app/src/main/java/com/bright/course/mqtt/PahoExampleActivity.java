...
public class PahoExampleActivity extends AppCompatActivity{
    ...
    final String serverUri = "tcp://node3.yanxishe.cc:1883";

    String clientId = "ExampleAndroidClient";
    final String subscriptionTopic = "ClassroomCtrlTopic";
    final String publishTopic = "ClassroomCtrlTopic";
    final String publishMessage = "1000";
