...
public class CanvasDrawer {
    ...
    public Bitmap getBitmap(int canvasWidth, int canvasHeight){
        Bitmap newBitmap = Bitmap.createBitmap(canvasWidth,canvasHeight,Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(newBitmap);
        canvas.drawBitmap(bitmap,viewRect.width()/2 - bitmap.getWidth()/2,20,null);
        return newBitmap;
    }
